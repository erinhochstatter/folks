  ...
  return (
    <div className="App">
      ...
      <ul style={{display: 'flex', flexDirection: 'column', alignItems: 'start'}}>
        ...
        <li> be able to change the tint & / or gradient for a feature (e.g. eye color, hair color)</li>
        <li><a href="https://github.com/sharonchoong/svg-exportJS">export the file</a></li>
      </ul>
      <Face/>
    </div>
  )
